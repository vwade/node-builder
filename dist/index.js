import { createContext, useContext, useRef, useMemo, useState, useEffect, useCallback } from 'react';
...
var Canvas_context = createContext(null);
function use_canvas() {
...
function Graph_canvas(props) {
  ...
  const pan_state_ref = useRef(null);
  const zoom_options = useMemo(() => ({
    min_scale,
    max_scale,
    zoom_sensitivity
  ...
  const edge_elements = render_edge ? /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      children: edges.map((edge) => {
        ...
        return /* @__PURE__ */ jsx("g", { "data-edge-id": edge.id, children: render_edge({
          edge,
          from: {
  ...
  return /* @__PURE__ */ jsx(Canvas_context.Provider, { value: context_value, children: /* @__PURE__ */ jsxs(
    "div",
    {
      ref: container_ref,
      ...
      children: [
        background,
        show_grid ? /* @__PURE__ */ jsx(Canvas_grid, { transform }) : null,
        /* @__PURE__ */ jsxs(
          "div",
          {
